...
export default function AboutMe() {
  ...
  return (
    <section id="about" className="relative z-20 bg-[#121212] py-32 px-6 lg:px-12 text-white border-t border-white/5">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="p-8 md:p-12 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 shadow-2xl relative overflow-hidden group min-h-[150px] flex items-center justify-center">
            ...
            {isLoading ? (
              ...
              <p className="text-xl md:text-2xl text-white/80 leading-relaxed font-light relative z-10 whitespace-pre-wrap">
                {aboutText}
              </p>
            )}
          </div>
