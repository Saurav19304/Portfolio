...
const DEFAULT_CONTACT = {
  email: "sauravvaghela22@gmail.com",
  phone: "+44 7352697112",
  linkedinUrl: "https://www.linkedin.com/in/sauravvaghela19/",
  linkedinName: "Saurav Vaghela",
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative z-20 bg-[#121212] py-32 px-6 lg:px-12 text-white border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative flex flex-col sm:flex-row justify-center sm:justify-around items-start sm:items-center p-8 md:p-12 z-10 gap-8 sm:gap-0 min-h-[250px]">
              {isLoading ? (
                <div className="text-white/40 text-sm animate-pulse">Loading contact information...</div>
              ) : (
                <>
                  <div className="flex flex-col space-y-10 w-full sm:w-auto">
                    <a href={`mailto:${contact.email}`} className="flex items-center space-x-6 group/link w-full">
                  ...
                  <div className="flex flex-col space-y-10 w-full sm:w-auto">
                    <a href={contact.linkedinUrl} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-6 group/link w-full">
                      <div className="w-14 h-14 shrink-0 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover/link:bg-white/10 transition-colors">
                        <span className="text-2xl">🔗</span>
                      </div>
                      <div className="flex-1 min-w-0">
